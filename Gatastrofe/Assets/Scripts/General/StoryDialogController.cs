...
public class StoryDialogController : MonoBehaviour
{
    ...
    // Funci�n que inicia el dialogo del NPC de la historia
    ...
    // Funci�n para saber cuando el NPC de la historia tiene que hablar con el jugador
    ...
    // Funci�n que coloca la linea de dialogo en el Texto
    private void ShowLine(string line)
    {
        DialogueText.text = line;
    }

    // Funci�n que muestra los dialogos
